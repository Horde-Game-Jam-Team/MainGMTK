...
void URPGAttributeSet::OnRep_FireCrystals(const FGameplayAttributeData& OldFireCrystals)
{
    GAMEPLAYATTRIBUTE_REPNOTIFY(URPGAttributeSet, FireCrystals, OldFireCrystals);
}
...
void URPGAttributeSet::GetLifetimeReplicatedProps(TArray<FLifetimeProperty>& OutLifetimeProps) const
{
    ...
    DOREPLIFETIME_CONDITION_NOTIFY(URPGAttributeSet, FireCrystals, COND_None, REPNOTIFY_Always);
